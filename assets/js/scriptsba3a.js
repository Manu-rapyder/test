...
NioApp = function (NioApp, $, window, document) {
    ...
    NioApp.promoPanel = function() {
        var _ruimg = (NioApp.getStatus.isRTL) ? '../images' : './images';
        $body.append('<div class="promo-sidebar"> <a href="#" class="promo-sidebar-trigger fas fa-cog"></a> <div class="promo-sidebar-content"> <div class="promo-block promo-btn"> <a href="http://bit.ly/2QFDoEX" target="_blank" class="btn">Purchase Now</a> <span class="promo-heading">Color Scheme</span> <ul class="color-panel"> <li> <a class="color-trigger style-default current" title="style" href="#"></a> </li><li> <a class="color-trigger style-blue" title="style-blue" href="#"></a> </li><li> <a class="color-trigger style-purple" title="style-purple" href="#"></a> </li><li> <a class="color-trigger style-green" title="style-green" href="#"></a> </li><li> <a class="color-trigger style-orange" title="style-orange" href="#"></a> </li></ul> </div><div class="promo-block promo-block-items"> <div class="promo-thumb"> <a href="index-alaska.html"> <div class="promo-image"><img src="' +_ruimg +'/promo-thumb-f.jpg" alt=""><span class="badge">v1.2</span><span class="badge badge-new">NEW</span></div><h5 class="promo-title">Alaska - OnePage Light</h5> </a> </div><div class="promo-thumb"> <a href="index-alaska-dark.html"> <div class="promo-image"><img src="' +_ruimg +'/promo-thumb-g.jpg" alt=""><span class="badge">v1.2</span><span class="badge badge-new">NEW</span></div><h5 class="promo-title">Alaska - OnePage Dark</h5> </a> </div><div class="promo-thumb"> <a href="index.html"> <div class="promo-image"><img src="' +_ruimg +'/promo-thumb-a.jpg" alt=""><span class="badge">v1.0</span> </div><h5 class="promo-title">Dallas - Digital</h5> </a> </div><div class="promo-thumb"> <a href="./index-dallas-dark.html"> <div class="promo-image"><img src="' +_ruimg +'/promo-thumb-c.jpg" alt=""><span class="badge">v1.1</span> </div><h5 class="promo-title">Dallas - Digital Dark</h5> </a> </div><div class="promo-thumb"> <a href="./index-texas.html"> <div class="promo-image"><img src="' +_ruimg +'/promo-thumb-b.jpg" alt=""><span class="badge">v1.0</span> </div><h5 class="promo-title">Texas - Digital</h5> </a> </div><div class="promo-thumb"> <a href="./index-florida.html"> <div class="promo-image"><img src="' +_ruimg +'/promo-thumb-d.jpg" alt=""><span class="badge">v1.0</span> </div><h5 class="promo-title">Florida - Digital</h5> </a> </div><div class="promo-thumb"> <a href="./index-jackson.html"> <div class="promo-image"><img src="' +_ruimg +'/promo-thumb-e.jpg" alt=""><span class="badge">v1.0</span> </div><h5 class="promo-title">Jackson - Digital</h5> </a> </div></div></div></div>');
        
        $(".promo-sidebar-trigger").on("click", function(e) {
            e.preventDefault();
            $(".promo-sidebar").toggleClass("active");
        })
        
        var $fixed_panle = $('.promo-btn'), _fp_height = $fixed_panle.innerHeight();
        $fixed_panle.next().css('margin-top', _fp_height);
    };
    NioApp.components.winLoad.push(NioApp.promoPanel);
